...
> Nota: `npm run deploy` copia los archivos desde `frontend/dist` a `backend/src/main/resources/static` y `backend/src/main/resources/templates` para que el backend (Spring Boot) los sirva.
